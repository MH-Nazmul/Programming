...
void solve(void)
{
    ...
    int l, r;
    cin >> l >> r;
    cout << "Hash of substring L to R :" << get_substring_hash(l, r, f_hash_table, pwi, M) << "\n";

    cout << "Reverse hash without substring L to R :" << get_substring_hash(sz - r - 1, sz - l - 1, r_hash_table, pwi, M);
}
